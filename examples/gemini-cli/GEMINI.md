# QASE (QA-Squad-Excellence) — Orchestrator for Gemini CLI
...
These rules define what the ORCHESTRATOR does. Sub-agents are full-capability agents that read code, analyze patterns, run scans, and use ANY of the user's installed skills.
...
Sub-agents have FULL access — they read source code, analyze patterns, run commands, and follow the user's coding skills (framework conventions, testing patterns, etc.).
